!function (t, e) {
    ...
    function ji(t, e, i, n) {
        ...
        if (i && (s += i[0] + i[2]), t && n) {
            ...
            if (null != l && s > l) t = "", a = []; else if (null != h) for (var u = Gi(h - (i ? i[1] + i[3] : 0), e, n.ellipsis, {
                minChar: n.minChar, placeholder: n.placeholder
    ...
    function Aa(t) {
        ...
        if (e && null == t.textFill) {
            ...
            n !== !1 && (n === !0 || e.isRectText && r && "string" == typeof r && r.indexOf("inside") >= 0) ? (i = {
                textFill: null, textStroke: t.textStroke, textStrokeWidth: t.textStrokeWidth
    ...
    function Cs(t, e, i, n, r, a) {
        r_.reset(i, n, r, a), t._callingProgress = e, t._callingProgress({
            start: i, end: n, count: n - i, next: r_.next
        }, t.context)
    }
    ...
    function qs(t, e, i, n, r) {
        function a(e) {
            ...
            n || (n = s.set(i, Is({reset: $s, onDirty: Qs})), o.dirty()), n.context = {
                model: e, overallProgress: u, modifyOutputEnd: c
    ...
    function yl(t, e, i) {
        ...
        var a = "canvas", o = this._zr = On(t, {
            renderer: i.renderer || a, devicePixelRatio: i.devicePixelRatio, width: i.width, height: i.height
        });
    ...
    function Sl(t, e) {
        ...
        Y_(u, function (t) {
            ...
            type: a.event || i, escapeConnect: n, batch: f
    ...
    function kh(t, e, i) {
        ...
        if (f(e, function (t, i) {
            ...
            f(e, function (t) {
                ...
                name: a, coordDim: u, coordDimIndex: d, type: c, isExtraCoord: !0, isCalculationCoord: !0
    ...
    function jh(t) {
        ...
        if ("category" === i.type) {
            for (var r = i.getBandWidth(), a = 0; a < t.count; a++) e.push(s({
                bandWidth: r, axisKey: n, stackId: jw + a
            }, t));
    ...
    function Uh(t) {
        ...
        return f(t, function (t) {
            ...
            e.push({
                bandWidth: o, barWidth: s, barMaxWidth: l, barGap: h, barCategoryGap: u, axisKey: Yh(r), stackId: Xh(t)
            })
        }), $h(e)
    }
    ...
    function $h(t) {
        ...
        f(t, function (t) {
            var i = t.axisKey, n = t.bandWidth, r = e[i] || {
                bandWidth: n, remainedWidth: n, autoWidthCount: 0, categoryGap: "20%", gap: "30%", stacks: {}
            }, a = r.stacks;
            e[i] = r;
            var o = t.stackId;
    ...
    function fu(t, e, i, n, r, a, o) {
        ...
        return l = 0 === t.indexOf("image://") ? Jr(t.slice(8), new gi(e, i, n, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? Qr(t.slice(7), {}, new gi(e, i, n, r), o ? "center" : "cover") : new Mb({
            shape: {
                symbolType: t, x: e, y: i, width: n, height: r
            }
    ...
    function Iu(t, e) {
        ...
        return w(n) ? a = Eu(t, n) : (o = "auto" === n ? Pu(t) : n, a = zu(t, o)), ku(i, n, {
            labels: a, labelCategoryInterval: o
        })
    }
    ...
    function $u(t, e, i, n, r, a) {
        ...
        wa(t, e, o, s, {
            labelFetcher: r, labelDataIndex: a, defaultText: Uu(r.getData(), a), isRectText: !0, autoColor: n
        }), Ku(t), Ku(e)
    }
        ...
        if (i && i.length && t.count() && "cartesian2d" === e.type) {
            ...
            if (r) {
                ...
                f(u, function (t) {
                    ...
                    offset: c ? u[c - 1].offset : .5, color: d[1] || "transparent"
    ...
    function vd(t, e, i, n) {
        ...
        return function (t, i) {
            return m = t, M = !0, p && p(s({
                dataIndexInside: t, dataIndex: e.getRawIndex(t), actionType: i ? i.type : null
            }, S), b)
        }
    }
    ...
    function Vd(t, e, i) {
        ...
        f(a, function (t, e) {
            ...
            type: "downplay", escapeConnect: !0, batch: l
    ...
    function hf(t, e, i, n, r, a) {
        ...
        i.labelMargin = r.get("label.margin"), af(e, n, r, a, {
            position: lf(n.axis, t, i), align: o.textAlign, verticalAlign: o.textVerticalAlign
        })
    }
    ...
    function kp(t) {
        if (!me(t) && Rp("moveOnMouseMove", t, this._opt) && this._dragging && "pinch" !== t.gestureEvent && !Tp(this._zr, "globalPan")) {
            ...
            this._x = e, this._y = i, this._opt.preventDefaultMouseMove && Ig(t.event), Ep(this, "pan", "moveOnMouseMove", t, {
                dx: a, dy: o, oldX: n, oldY: r, newX: e, newY: i
            })
        }
    }
    ...
    function Bp(t, e) {
        ...
        var a = i[r];
        a || (a = i[r] = {
            coordId: r, dataZoomInfos: {}, count: 0
                ...
                f(e.dataZoomInfos, function (r) {
                    if (i.isAvailableBehavior(r.dataZoomModel.option)) {
                        ...
                        !r.dataZoomModel.get("disabled", !0) && o && n.push({
                            dataZoomId: r.dataZoomId, start: o[0], end: o[1]
                        })
                    }
    ...
    var Dg = "undefined" == typeof Float32Array ? Array : Float32Array, kg = (Object.freeze || Object)({
        create: be, identity: Se, copy: Me, mul: Ie, translate: Te, rotate: Ce, scale: Ae, invert: De, clone: ke
    ...
    var _y = Fr.extend({
        ...
        by = function (t) {
            ...
            type: "polygon", shape: {points: null, smooth: !1, smoothConstraint: null}, buildPath: function (t, e) {
                jr(t, e, !0)
            }
        }), Ay = Fr.extend({
            type: "polyline",
    ...
    var Qx = {
        ...
        }, objectRows: {pure: !0, count: ms, getItem: ys, appendData: xs}, keyedColumns: {
            pure: !0, count: function () {
        ...
        }, original: {count: ms, getItem: ys, appendData: xs}, typedArray: {
    ...
    var f_ = {
        ...
        toolbox: {
            ...
            general: {withTitle: "这是一个关于“{title}”的图表。", withoutTitle: "这是一个图表，"}, series: {
                single: {
                ...
                l += i(n(g), {seriesCount: s}), e.eachSeries(function (t, e) {
                    if (c > e) {
                        ...
                        r = n(o ? l + "withName" : l + "withoutName"), r = i(r, {
                            seriesId: t.seriesIndex, seriesName: t.get("name"), seriesType: a(t.subType)
                        });
                        var u = t.getData();
    ...
    Xs.wrapStageHandler = function (t, e) {
        return w(t) && (t = {
            overallReset: t, seriesType: rl(t)
    ...
    sl.prototype.parse = function (t, e) {
        ...
        if (r) {
            var u = z(r).split(E_);
            u.length >= 4 && (l = {
                x: parseFloat(u[0] || 0), y: parseFloat(u[1] || 0), width: parseFloat(u[2]), height: parseFloat(u[3])
            })
        }
        ...
        var r = new xy({
            style: {text: t.textContent, transformText: !0}, position: [this._textX || 0, this._textY || 0]
        });
    ...
    var R_ = {
        ...
        tw = 5e3, ew = 1e3, iw = 2e3, nw = 3e3, rw = 4e3, aw = 5e3, ow = {
            PROCESSOR: {FILTER: J_, STATISTIC: tw}, VISUAL: {LAYOUT: ew, GLOBAL: iw, CHART: nw, COMPONENT: rw, BRUSH: aw}
            ...
            this._zr.on(t, function (e) {
                ...
                if (i) {
                    ...
                    i.event = e, i.type = t, this._ecEventProcessor.eventInfo = {
                        targetEl: r, packedEvent: i, model: u, view: c
                    }, this.trigger(t, i)
                }
            }, this)
    ...
    var Ab = function (t) {
        return _u(t), p(v(t.features, function (t) {
            ...
            "Polygon" === i.type && r.push({
                type: "polygon", exterior: n[0], interiors: n.slice(1)
    ...
    Vb("x", Wb, Wu, Gb), Vb("y", Wb, Wu, Gb), yx.extend({
        type: "grid", dependencies: ["xAxis", "yAxis"], layoutMode: "box", coordinateSystem: null, defaultOption: {
            show: !1,
            zlevel: 0,
            z: 0,
            left: "10%",
    ...
    var Xb = o_.extend({
        type: "series.__base_bar__", getInitialData: function () {
    ...
    lS.extend({type: "xAxis"}), lS.extend({type: "yAxis"}), nh({
        ...
        type: "series.line", dependencies: ["grid", "polar"], getInitialData: function () {
            return Oh(this.getSource(), this)
        }, defaultOption: {
            zlevel: 0,
            z: 2,
    ...
    var vS = function (t, e, i, n, r, a, o, s) {
        ...
        type: "ec-polygon", shape: {
            ...
            smoothMonotone: null,
            connectNulls: !1
        }, brush: by(Fr.prototype.brush), buildPath: function (t, e) {
    ...
    Bs.extend({
        type: "line", init: function () {
            ...
            f && c.type === n.type && M === this._step ? (m && !p ? p = this._newPolygon(h, _, n, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Jc(n, !1, !1, t)), w && d.updateData(a, {
                isIgnore: b, clipShape: Jc(n, !1, !0, t)
            ...
            if (T = qc(t.get("smooth")), f.setShape({
                smooth: T, smoothMonotone: t.get("smoothMonotone"), connectNulls: t.get("connectNulls")
            }), p) {
                var C = a.getCalculationInfo("stackedOnSeries"), A = 0;
                p.useStyle(s(l.getAreaStyle(), {
                    fill: I, opacity: .7, lineJoin: "bevel"
            ...
            return e && this._lineGroup.remove(e), e = new MS({
                shape: {points: t}, silent: !0, z2: 10
            }), this._lineGroup.add(e), this._polyline = e, e
        }, _newPolygon: function (t, e) {
            var i = this._polygon;
            return i && this._lineGroup.remove(i), i = new IS({
                shape: {points: t, stackedOnPoints: e}, silent: !0
    ...
    var TS = function (t, e, i) {
        return {
            seriesType: t, performRawSeries: !0, reset: function (t, n) {
                ...
                if (a.setVisual({
                    legendSymbol: i || o, symbol: o, symbolSize: s, symbolKeepAspect: l
    ...
    var PS = function (t, e, i) {
        ...
        type: "series.pie", init: function (t) {
            ...
            for (var t = this.getRawData(), e = t.mapDimension("value"), i = [], n = 0, r = t.count(); r > n; n++) i.push({
                name: t.getName(n), value: t.get(e, n), selected: Ms(t, n, "selected")
            });
            return i
    ...
    zS.updateData = function (t, e, i) {
        ...
        wa(n.style, n.hoverStyle = {}, h, u, {
            ...
            textAlign: s.textAlign, textVerticalAlign: s.verticalAlign, opacity: t.getItemVisual(e, "opacity")
            ...
            stroke: l, opacity: t.getItemVisual(e, "opacity")
    ...
    var ES = (Bs.extend({
        ...
        e.eachSeriesByType(t, function (t) {
            ...
            if (e.each(n, function (t, i) {
                ...
                var r = I + T * n;
                e.setItemLayout(i, {
                    angle: n, startAngle: I, endAngle: r, clockwise: y, cx: h, cy: u, r0: c, r: x ? qa(t, b, [c, d]) : d
                }), I = r
            }), NS > S && g) if (.001 >= S) {
                var C = NS / g;
    ...
    var GS = function (t) {
            ...
            return {
                coordSys: {type: "cartesian2d", x: e.x, y: e.y, width: e.width, height: e.height}, api: {
                    coord: function (e) {
            ...
            return {
                coordSys: {type: "geo", x: e.x, y: e.y, width: e.width, height: e.height, zoom: t.getZoom()}, api: {
                    coord: function (e) {
                        return t.dataToPoint(e)
                    }, size: y(ud, t)
                }
            ...
            var e = t.getRect();
            return {
                coordSys: {type: "singleAxis", x: e.x, y: e.y, width: e.width, height: e.height}, api: {
                    coord: function (e) {
                        return t.dataToPoint(e)
                    }, size: y(cd, t)
                }
            ...
            return n[0] > n[1] && n.reverse(), {
                coordSys: {type: "polar", cx: t.cx, cy: t.cy, r: n[1], r0: n[0]}, api: {
                    coord: y(function (n) {
    ...
    o_.extend({
        ...
        type: "title", layoutMode: {type: "box", ignoreSize: !0}, defaultOption: {
            zlevel: 0,
            z: 6,
            show: !0,
            text: "",
            ...
            if (this.group.removeAll(), t.get("show")) {
                var n = this.group, r = t.getModel("textStyle"), a = t.getModel("subtextStyle"), o = t.get("textAlign"),
                    s = t.get("textBaseline"), l = new xy({
                        style: ba({}, r, {text: t.get("text"), textFill: r.getTextColor()}, {disableBox: !0}), z2: 10
                    }), h = l.getBoundingRect(), u = t.get("subtext"), c = new xy({
                        style: ba({}, a, {
                            text: u, textFill: a.getTextColor(), y: h.height + t.get("itemGap"), textVerticalAlign: "top"
                        }, {disableBox: !0}), z2: 10
    ...
    var tM = x, eM = f, iM = lv, nM = nh({
        type: "legend.plain", newlineDisabled: !1, init: function () {
            ...
            var I = new Dy({
                shape: g.getBoundingRect(), invisible: !0, tooltip: y.get("show") ? o({
                    content: t,
    ...
    var aM = JS.extend({
        type: "legend.scroll", setScrollDataIndex: function (t) {
    ...
    var uM = function (t, e) {
        ...
        type: "axisPointer", coordSysAxesInfo: null, defaultOption: {
            show: "auto",
            triggerOn: null,
            zlevel: 0,
            z: 50,
    ...
    var wM = Kd.extend({
        makeElOption: function (t, e, i, n, r) {
            ...
            return n.labelMargin = i.get("handle.margin"), {
                position: lf(e.axis, t, n), rotation: n.rotation + (n.labelDirection < 0 ? Math.PI : 0)
            }
    ...
    rS.registerAxisPointerClass("CartesianAxisPointer", wM), Yl(function (t) {
        ...
        type: "tooltip", dependencies: ["axisPointer"], defaultOption: {
            zlevel: 0,
            z: 60,
            show: !0,
            showContent: !0,
        ...
        type: "tooltip", init: function (t, e) {
            ...
            if (n.from !== this.uid && !tg.node) {
                ...
                if (n.tooltip && null != n.x && null != n.y) {
                    ...
                    o.position = [n.x, n.y], o.update(), o.tooltip = n.tooltip, this._tryShow({
                        offsetX: n.x, offsetY: n.y, target: o
                    }, r)
                    ...
                    null != l && null != h && this._tryShow({
                        offsetX: l, offsetY: h, position: n.position, target: s.el, event: {}
                    }, r)
            ...
            if (null == c || "item" === c) {
                ...
                this._showOrMove(u, function () {
                    ...
                    type: "showTip", dataIndexInside: s, dataIndex: h.getRawIndex(s), seriesIndex: r, from: this.uid
                })
            }
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([i, n], a, r.el, d, {
                viewSize: [s, l], contentSize: h.slice()
    ...
    GM.beforeUpdate = Gf, GM._createLine = function (t, e, i) {
        ...
        r.useStyle(s({
            strokeNoScale: !0, fill: "none", stroke: c, opacity: d
    ...
    var ZM = function (t, e, i, a) {
        ...
        if (!_(a) && ("min" === l || "max" === l || "average" === l || "median" === l || null != a.xAxis || null != a.yAxis)) {
            ...
            m >= 0 && "number" == typeof c && (c = +c.toFixed(Math.min(m, 20))), g.coord[f] = v.coord[f] = c, a = [g, v, {
                type: l, valueIndex: a.valueIndex, value: c
            }]
        }
        ...
        type: "markArea", updateTransform: function (t, e, i) {
            ...
            e.setData(u), u.each(function (e) {
                ...
                t.useStyle(s(n.getModel("itemStyle").getItemStyle(), {
                    fill: Ke(o, .4), stroke: o
                })), t.hoverStyle = n.getModel("emphasis.itemStyle").getItemStyle(), wa(t.style, t.hoverStyle, r, a, {
                    labelFetcher: e, labelDataIndex: i, defaultText: u.getName(i) || "", isRectText: !0, autoColor: o
                }), xa(t, {}), t.dataModel = e
    ...
    var qM = yx.extend({
        type: "timeline", layoutMode: "box", defaultOption: {
            zlevel: 0,
            z: 4,
            show: !0,
            axisType: "time",
        ...
        type: "timeline.slider", init: function (t, e) {
            ...
            if (r.get("show")) {
                ...
                JM(o, function (n) {
                    ...
                    ba(u.style, s, {
                        text: n.formattedLabel, textAlign: t.labelAlign, textVerticalAlign: t.labelBaseline
                    }), e.add(u), xa(u, ba({}, l))
                }, this)
            }
            ...
            function r(t, i, r, u) {
                if (t) {
                    var c = {
                        position: t, origin: [a / 2, 0], rotation: u ? -o : 0, rectHover: !0, style: s, onclick: r
                    }, d = up(n, i, h, c);
                    e.add(d), xa(d, l)
                }
            }
            ...
            "+" === t ? t = e + 1 : "-" === t && (t = e - 1), this.api.dispatchAction({
                type: "timelineChange", currentIndex: t, from: this.uid
            })
        }
            ...
            return e.eachSeries(function (i) {
                if (fp(i.get("coordinateSystem"))) {
                    var n = this._dimName, r = e.queryComponents({
                        mainType: n + "Axis", index: i.get(n + "AxisIndex"), id: i.get(n + "AxisId")
                    })[0];
    ...
    var sI = f, lI = nI, hI = ih({
            ...
            type: "dataZoom.slider", layoutMode: "box", defaultOption: {
                show: !0,
                right: "ph",
                top: "ph",
                width: "ph",
            ...
            type: "dataZoom.slider", init: function (t, e) {
                ...
                var t = this.dataZoomModel, e = this.api, i = this._findCoordRect(),
                    n = {width: e.getWidth(), height: e.getHeight()}, r = this._orient === _I ? {
                        right: n.width - i.x - i.width, top: n.height - xI - mI, width: i.width, height: xI
                        ...
                        f(o, function (t) {
                            if (!(i || e !== !0 && h(SI, t.get("type")) < 0)) {
                                ...
                                null != l && u.getOtherAxis && (o = u.getOtherAxis(s).inverse), l = t.getData().mapDimension(l), i = {
                                    thisAxis: s, series: t, thisDim: r.name, otherDim: l, otherAxisInverse: o
                                }
                            }
                        }, this)
                    }, this), i
                ...
                n.add(t.filler = new dI({
                    ...
                    silent: !0, shape: {x: 0, y: 0, width: r[0], height: r[1]}, style: {
                        stroke: a.get("dataBackgroundColor") || a.get("borderColor"), lineWidth: yI, fill: "rgba(0,0,0,0)"
                    }
                }))), vI([0, 1], function (t) {
    ...
    hI.extend({
        type: "dataZoom.inside", defaultOption: {
            disabled: !1,
            zoomLock: !1,
            zoomOnMouseWheel: !0,
            moveOnMouseMove: !0,
        ...
        for (var yT = new gi, xT = function (t, e, i, n) {
            ...
            if (null != a && (a += ""), a) {
                ...
                sT(I, "fill", {fill: r.textFill, opacity: r.opacity}, this), sT(I, "stroke", {
                    stroke: r.textStroke, opacity: r.opacity, lineDash: r.lineDash
